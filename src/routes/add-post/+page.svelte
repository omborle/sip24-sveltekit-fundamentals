...
<form class="container mx-auto p-5" method ="POST" enctype="multipart/form-data">
    ...
    <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer">
        <div class="flex flex-col items-center justify-center pt-5 pb-6">
            ...
            {:else}
            <svg class="w-8 h-8 mb-4 text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="black"/>
    ...
    <div class ="mb-3">
        ...
        <input name ="username" type="text" class="bg-gray-50 border border-gray-900 text-sm rounded-lg block w-full p-2.5"/>
    </div>
    <div  class ="mb-3">
        <label for="content" class ="block mb-2 text-sm font-medium text-gray=900">Content</label>
        <textarea name ="content" type="text" class="bg-gray-50 border border-gray-900 text-sm rounded-lg block w-full p-2.5"></textarea>
    </div>
